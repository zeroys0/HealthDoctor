...
public class HospitalCureActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_hospital_cure);
        context = this;
        init();
    }
    public void init(){
...
//        fragments.add(new CureDoneFragment());
        ...
        view_pager.setAdapter(new Pager2Adapter(HospitalCureActivity.this,fragments));
